...
/**
 * --------------------------------------------------------------------------
 * ON Standards (v2.0.0-alpha): off-canvas.js
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 * --------------------------------------------------------------------------
 */
...
var OffCanvas = (function ($) {
  ...
  var ClassName = {
    ...
    OPEN: 'off-canvas-open',
    FADE: 'fade',
    IN: 'in'
  };

  var Selector = {
    DIALOG: '.off-canvas-pane',
    DATA_TOGGLE: '[data-toggle="off-canvas"]',
    DATA_DISMISS: '[data-dismiss="off-canvas"]',
    FIXED_CONTENT: '.navbar-fixed-top, .navbar-fixed-bottom, .is-fixed'
  };
  ...
  var OffCanvas = (function () {
    ...
    _createClass(OffCanvas, [{
      ...
      value: function show(relatedTarget) {
        ...
        $(this._backdrop).on(Event.MOUSEDOWN_DISMISS, function () {
          $(_this._element).one(Event.MOUSEUP_DISMISS, function (event) {
            if ($(event.target).is(_this._element)) {
              _this._ignoreBackdropClick = true;
            }
      ...
      value: function hide(event) {
        ...
        if (Util.supportsTransitionEnd() && $(this._element).hasClass(ClassName.FADE)) {
          ...
          $(this._element).one(Util.TRANSITION_END, $.proxy(this._hideOffCanvas, this)).emulateTransitionEnd(TRANSITION_DURATION);
        } else {
          this._hideOffCanvas();
        }
      }
      ...
      value: function _showBackdrop(callback) {
        ...
        if (this._isShown && this._config.backdrop) {
          ...
          $(this._backdrop).add($(this._element)).on(Event.CLICK_DISMISS, function (event) {
            if (_this6._ignoreBackdropClick) {
              _this6._ignoreBackdropClick = false;
              return;
            }
      ...
      value: function _jQueryInterface(config, relatedTarget) {
        return this.each(function () {
          var data = $(this).data(DATA_KEY);
          var _config = $.extend({}, OffCanvas.Default, $(this).data(), typeof config === 'object' && config);
